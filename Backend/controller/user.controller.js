...
import { findUserByEmail, findUserById, getAllUsers as getAllUsersModel, archiveUserById, getArchivedUsers, searchUsers as searchUsersModel } from "../models/user.model.js";
...
export const signup = async (req, res) => {
    try {
        ...
        const { fullname, name, email, password, designation, job_title, department, phone, date_of_joining, employee_id, profile_picture, status, role, gender } = req.body;
